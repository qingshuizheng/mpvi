...
(defvar mpvi-seek-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "l")   (lambda () (interactive) (mpvi-seeking-walk 1)))
    (define-key map (kbd "j")   (lambda () (interactive) (mpvi-seeking-walk -1)))
    (define-key map (kbd "h")   (lambda () (interactive) (mpvi-seeking-walk 3)))
    (define-key map (kbd ":")   (lambda () (interactive) (mpvi-seeking-walk -3)))
    (define-key map (kbd "L")   (lambda () (interactive) (mpvi-seeking-walk "1%")))
    (define-key map (kbd "J")   (lambda () (interactive) (mpvi-seeking-walk "-1%")))
    (define-key map (kbd ".")   (lambda () (interactive) (mpvi-seeking-walk :ff)))
    (define-key map (kbd ",")   (lambda () (interactive) (mpvi-seeking-walk :fb)))
    ...
    (define-key map (kbd "]")   (lambda () (interactive) (mpvi-speed 1)))
    (define-key map (kbd "[")   (lambda () (interactive) (mpvi-speed -1)))
    (define-key map (kbd "DEL") (lambda () (interactive) (mpvi-speed nil)))
